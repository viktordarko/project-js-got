...
const nextEnemySpot = (enemies) => {
  ...
  // We don't want to place two enemies in the same lane. 
  // To accomplish this, we create an empty array, the empty spots are considered falsy values, any true value will fill up a spot in the array, leaving the previous spots as empty values (false)
...
// addBackground contains all the logic to display the background of the game.
